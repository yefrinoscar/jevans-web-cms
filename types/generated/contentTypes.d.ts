...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ourValues: Schema.Attribute.Component<'shared.our-value', true>;
    ourVission: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<'blocks.address', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.Text;
    type: Schema.Attribute.Enumeration<['Evento', 'Conferencia', 'Workshop']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    banner: Schema.Attribute.Component<'shared.banner-v2', false>;
    banners: Schema.Attribute.Component<'shared.banner', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'shared.copy', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    time_lecture: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    benefits: Schema.Attribute.Component<'shared.section-benefit', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'blocks.block-cta', false>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'shared.block-service', true>;
...
export interface ApiSuccessCaseSuccessCase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    challenge: Schema.Attribute.Component<'shared.section-success-case', false>;
    ...
    kpis: Schema.Attribute.Component<'shared.kpis', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    solution: Schema.Attribute.Component<'shared.section-success-case', false>;
